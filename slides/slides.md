...
<div class="text-lg opacity-80 mt-1">{{ $t("ssr_flow.subtitle") }}</div>
...
| {{ $t("ssr_flow.col_cost") }} | {{ $t("ssr_flow.col_detail") }} |
|---|---|
| {{ $t("ssr_flow.i1t") }} | {{ $t("ssr_flow.i1d") }} |
| {{ $t("ssr_flow.i2t") }} | {{ $t("ssr_flow.i2d") }} |

</div>

<!-- Single message: server-side rendering is the baseline Wasm replaces — a dedicated visualization server costs time and money to run, and confidential client data must travel to it over the network. -->
<!-- $t("script.s6") -->
