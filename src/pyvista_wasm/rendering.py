...
class _BaseHTMLRenderer:
    ...
    def _generate_render_js(self) -> str:
        ...
        return (
            ...
            "      msg.style.cssText = 'margin:12px 0 0;color:#f85149;"
            "font:14px/1.4 sans-serif;text-align:center;max-width:360px;';\n"
            f"      msg.textContent = 'Failed to load VTK.wasm"
            f" from {_json.dumps(_VTKWASM_UMD)}.';\n"
