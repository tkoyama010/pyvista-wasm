...
/** A set of 3D points. */
interface VtkPoints {
  // biome-ignore lint/nursery/useConsistentMethodSignatures: VTK.wasm API requires method-style
...
interface VtkInteractorStyleManager {
...
// biome-ignore lint/style/useNamingConvention: external API name from @kitware/vtk-wasm
